...
sequence_input = Input(batch_shape=(MAX_SEQUENCE_LENGTH,), dtype='int32')
sequence_lengths = Input(batch_shape=[MAX_SEQUENCE_LENGTH,1], dtype='int32')
...
crf = CRFLayer()
pred = crf(inputs=[gru_kata, sequence_lengths])
model = Model(inputs=[sequence_input, sequence_lengths], outputs=[pred])
model.summary()
