...
word = DI()
word.load('word.ner')
label = DI()  # training label and testing label should be the same
label.load('label')
...
print 'Found additional', word.cnt - 1, 'unique words.'
...
optimizer = 'rmsprop'  # raw_input('Enter optimizer (default rmsprop): ')
...
epoch = 0  # input('Enter number of epochs: ')
