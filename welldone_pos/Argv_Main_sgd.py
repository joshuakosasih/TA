...
if a[10] == '.':
    ...
    neste = True
if a[11] == '.':
    optimizer = optimizers.SGD(lr=0.01, momentum=0.0, decay=0.0, nesterov=neste)
else:
    optimizer = optimizers.SGD(lr=0.01, momentum=0.0, decay=0.0, nesterov=neste, clipnorm=0.5)
loss = 'categorical_crossentropy'
model.summary()
print 'Nestervo:', neste
print 'Gradient clipping:', a[11]
